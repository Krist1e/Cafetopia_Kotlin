...
import by.bsuir.cafetopia.ui.screens.profile.EditProfileState
        ...
        Surface(
            ...
            Column(
                ...
                PersonalInfoSection(
                    ...
                    onCityChanged = { state = state.copy(city = it) },
                    onFavoriteFoodChanged = { state = state.copy(favoriteFood = it) },
...
private fun PersonalInfoSection(
    ...
    onFavoriteFoodChanged: (String) -> Unit,
    ...
    FormSection(header = "Personal Info", modifier = modifier) {
        Column(
            ...
            ProfileInputField(
                ...
                onValueChanged = onFavoriteFoodChanged,
                modifier = Modifier.fillMaxWidth()
            )
            GenderSelector(
